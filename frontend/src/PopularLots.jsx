      ...
      <div className="w-full md:w-[60%] relative">
        ...
        >
          <SwiperSlide className="bg-textColor text-background rounded-md flex flex-col justify-between">
              ...
              <p className="text-sm sm:text-md px-2 line-clamp-3">A bustling place with lots of activities from people and businesses.</p>
          ...
          <SwiperSlide className="bg-textColor text-background rounded-md flex flex-col justify-between ">
              ...
              <p className="text-sm sm:text-md px-2 line-clamp-3">It's a very big apportioned space for parking vehicles..</p>
              <div className="flex justify-between px-2 py-2">
